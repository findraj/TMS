...
public:
  ...
  std::vector<std::vector<double>> color_data{
      {1.0046, 0.9399, 0.9792, 0.0000, 0.1648, 0.0000, 1.0000},
      {1.0046, 0.9707, 1.0008, 0.0000, 0.0003, 0.0000, 1.0000},
      {1.0046, 1.0098, 0.8775, 0.2453, 0.0000, 0.1427, 0.7712},
      {1.0043, 1.0099, 0.1293, 0.7623, 0.0000, 0.8842, 0.2295},
      {0.9967, 1.0099, 0.0000, 1.0000, 0.0000, 1.0000, 0.0000},
      {0.9967, 1.0088, 0.0000, 1.0000, 0.0000, 0.9772, 0.0000},
      {1.0028, 0.2921, 0.7372, 1.0000, 0.6317, 0.2828, 0.0000},
      {1.0046, 0.0000, 1.0007, 0.9744, 1.0716, 0.0000, 0.0237},
      {1.0045, 0.0000, 1.0005, 0.9767, 1.0716, 0.0000, 0.0433},
      {1.0046, 0.0001, 1.0008, 0.9912, 1.0716, 0.0000, 0.0465}};

  std::vector<double> LMSsensitivitiesIndex = {400.0, 433.3, 466.7, 500.0, 533.3, 566.7, 600.0, 633.3, 666.7, 700.0};
